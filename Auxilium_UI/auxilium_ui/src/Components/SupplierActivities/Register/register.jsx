    ...
    componentDidMount(){
        ...
        this.setState({
            dropDownList1 : [
                ...
                {name: "Andhra Pradesh", dropDownList2: [ "Adoni",
                "Amalapuram",
                "Anakapalle",
                "Anantapur",
                "Bapatla",
                ...
                {name: "Arunachal Pradesh", dropDownList2: ["Naharlagun",
                "Pasighat"]},


                {name: "Assam", dropDownList2: ["Barpeta",
                "Bongaigaon City",
                "Dhubri",
                "Dibrugarh",
                "Diphu",
                ...
                {name: "Bihar", dropDownList2: [ "Araria",
                "Arrah",
                "Arwal",
                "Asarganj",
                "Aurangabad",
                ...
                {name: "Chhattisgarh", dropDownList2: [ "Ambikapur",
                "Bhatapara",
                "Bhilai Nagar",
                "Bilaspur",
                "Chirmiri",
                ...
                {name: "Delhi", dropDownList2: ["Delhi",
                "New Delhi*"]},


                {name: "Goa", dropDownList2: ["Mapusa",
                "Margao",
                "Marmagao",
                "Panaji*"]},


                {name: "Gujarat", dropDownList2: ["Adalaj",
                "Ahmedabad",
                "Amreli",
                "Anand",
                "Anjar",
                ...
                {name:  "Haryana", dropDownList2: ["Bahadurgarh",
                "Bhiwani",
                "Charkhi Dadri",
                "Faridabad",
                "Fatehabad",
                ...
                {name: "Himachal Pradesh", dropDownList2: [ "Mandi",
                "Nahan",
                "Palampur",
                "Shimla*",
                "Solan",
                ...
                {name: "Jammu and Kashmir", dropDownList2: ["Anantnag",
                "Baramula",
                "Jammu",
                "Kathua",
                "Punch",
                ...
                {name: "Jharkhand", dropDownList2: ["Adityapur",
                "Bokaro Steel City",
                "Chaibasa",
                "Chatra",
                "Chirkunda",
                ...
                {name: "Karnataka", dropDownList2: [ "Adyar",
                "Afzalpur",
                "Arsikere",
                "Athni",
                "Bengaluru",
                ...
                {name: "Kerala", dropDownList2: [ "Adoor",
                "Alappuzha",
                "Attingal",
                "Chalakudy",
                "Changanassery",
                ...
                {name: "Madhya Pradesh", dropDownList2: [ "Alirajpur",
                "Ashok Nagar",
                "Balaghat",
                "Bhopal",
                "Ganjbasoda",
                ...
                {name: "Maharashtra", dropDownList2: [ "Ahmednagar",
                "Akola",
                "Akot",
                "Amalner",
                "Ambejogai",
                ...
                {name: "Manipur", dropDownList2: ["Imphal*",
                "Lilong",
                "Mayang Imphal",
                "Thoubal"]},


                {name: "Meghalaya", dropDownList2:["Nongstoin",
                "Shillong*",
                "Tura"]},


                {name: "Mizoram", dropDownList2: ["Aizawl",
                "Lunglei",
                "Saiha"]},


                {name: "Nagaland", dropDownList2: ["Dimapur",
                "Kohima*",
                "Mokokchung",
                "Tuensang",
                "Wokha",
                ...
                {name: "Odisha", dropDownList2:[ "Balangir",
                "Baleshwar Town",
                "Barbil",
                "Bargarh",
                "Baripada Town",
                ...
                {name: "Puducherry", dropDownList2: [ "Karaikal",
                "Mahe",
                "Pondicherry*",
                "Yanam"]},


                {name: "Punjab", dropDownList2: [ "Amritsar",
                "Barnala",
                "Batala",
                "Bathinda",
                "Dhuri",
                ...
                {name: "Rajasthan", dropDownList2: ["Ajmer",
                "Alwar",
                "Bikaner",
                "Bharatpur",
                "Bhilwara",
                ...
                {name: "Tamil Nadu", dropDownList2: [ "Arakkonam",
                "Aruppukkottai",
                "Chennai*",
                "Coimbatore",
                "Erode",
                ...
                {name: "Telangana", dropDownList2:["Adilabad",
                "Bellampalle",
                "Bhadrachalam",
                "Bhainsa",
                "Bhongir",
                ...
                {name: "Tripura", dropDownList2: [ "Agartala*",
                "Belonia",
                "Dharmanagar",
                "Kailasahar",
                "Khowai",
                ...
                {name: "Uttar Pradesh", dropDownList2: [ "Achhnera",
                "Agra",
                "Aligarh",
                "Allahabad",
                "Amroha",
                ...
                {name: "Uttarakhand", dropDownList2: ["Bageshwar",
                "Dehradun",
                ...
                {name: "West Bengal", dropDownList2: [ "Adra",
                "Alipurduar",
                "Arambagh",
                "Asansol",
                "Baharampur",
