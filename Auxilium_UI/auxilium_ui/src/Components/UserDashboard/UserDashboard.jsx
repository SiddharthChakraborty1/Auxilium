...
<<<<<<< HEAD
  IconButton,
=======
>>>>>>> 664b966d1c3b3a2b355c36cd5d460fe42e7308f3
  makeStyles,
          ...
          {cityWiseList.map((item) => (
            <div>
              <UserCard
                ...
                location={
                  props.productType != "Food Services"
                    ? item.productServiceAddress
                    : item.foodServiceAddress
                }
                date={
                  props.productType != "Food Services"
                    ? item.productLastModifyDate
                    : item.foodLastModifyDate
                }
                ...
                product={
                  props.productType != "Food Services" ? "Product" : "Food"
                }
                productType={
                  props.productType != "Food Services"
                    ? item.productType
