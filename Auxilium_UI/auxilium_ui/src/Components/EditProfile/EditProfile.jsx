            ...
            <Container className="Form-box">
                <Form className="mx-auto form">
                    ...
                    {/* <Form.Group>
                        ...
                        <Form.Control type="select" onChange={handleState} style={{ backgroundColor: "black", color: "white", borderColor: "orange" }} >
                            <option>asd</option>
                            {/* {
                                locations.dropDownList1.map((state) => (
                    ...
                    <Form.Group>
                        ...
                        <Form.Control as="select" placeholder={state} onChange={handleState} style={{ backgroundColor: "black", color: "white", borderColor: "orange" }}>
                            {/* <option>asd</option> */}
                    ...
                    <Form.Group>
                        ...
                        <Form.Control as="select" placeholder={state} onChange={handleCity} style={{ backgroundColor: "black", color: "white", borderColor: "orange" }}>
                            {/* <option>asd</option> */}
                            <option value="reselect">--Select state--</option>
                            {
                                locations.dropDownList1.find((x) => x.name === newState).dropDownList2.map((city)=>(
                                    <option value={city}>{city}</option>
                                ))
                                // newState.dropDownList2.map((city)=>(
                                //     <option value={city}>{city}</option>
                                // ))
                            }
                        </Form.Control>
